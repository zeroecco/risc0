...
template <typename C> FDEV void MemReadBlock<C>::addArguments(CTX, Val<C> cycle) DEV {
...
template <typename C> FDEV void MemWriteBlock<C>::addArguments(CTX, Val<C> cycle) DEV {
  ctx.pull(
